...
from lecture_2.hw.shop_api.contracts import CartResponse, ItemResponse, ItemPatchRequest
from lecture_2.hw.store import queries
from lecture_2.hw.store.resources import ItemInfo
